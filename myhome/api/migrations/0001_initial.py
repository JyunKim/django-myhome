# Generated by Django 3.0.8 on 2020-12-30 18:49
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('집주인', '집주인'), ('세입자', '세입자'), ('멘토', '멘토')], max_length=10, verbose_name='역할')),
            ],
        ),
        migrations.CreateModel(
            name='Room',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('mentor', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='reviews', to='api.Account', verbose_name='멘토')),
                ('tenant', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='written_reviews', to='api.Account', verbose_name='작성자')),
            ],
        ),
        migrations.CreateModel(
            name='Photo',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('content', models.CharField(max_length=40, verbose_name='하고 싶은 말')),
                ('rate', models.FloatField(validators=[api.models.rate_validator], verbose_name='평점')),
                ('room', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='comments', to='api.Room', verbose_name='매물')),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='comments', to='api.Account', verbose_name='작성자')),
            ],
        ),
        migrations.AddField(
            model_name='account',
